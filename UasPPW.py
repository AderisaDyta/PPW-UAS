...
with tab1:
        ...
        dataset = pd.read_csv("https://raw.githubusercontent.com/AderisaDyta/PPW-UAS/main/Crawling-DataBerita.csv")
...
with tab2:
        dataset = pd.read_csv("https://raw.githubusercontent.com/AderisaDyta/PPW-UAS/main/Data-Bersih.csv")
        st.dataframe(dataset)
        st.info(f"Banyak Dataset : {len(dataset)}")
        st.warning(f'Informasi Dataset')
        st.write(dataset.describe())
...
with tab3:
        dataset = pd.read_csv("https://raw.githubusercontent.com/AderisaDyta/PPW-UAS/main/Datasummary-Beritasatu.csv")
        st.dataframe(dataset)
        st.info(f"Banyak Dataset : {len(dataset)}")
        st.warning(f'Informasi Dataset')
        st.write(dataset.describe())
...
with tab4:
        ...
        csv_path = 'https://raw.githubusercontent.com/AderisaDyta/PPW-UAS/main/classification_results.csv'
        ...
        csv_path = 'https://raw.githubusercontent.com/AderisaDyta/PPW-UAS/main/classification_results_svm.csv'
        df = pd.read_csv(csv_path)
        df
        # Menampilkan gambar
